...
E2E demo: dictate a voice note locally -> FlyMyAI cloud agent transcribes (cloud STT), cleans it up, extracts keywords (incl. spoken tags like "тег демо") -> files it into a Notion database -> returns the text to your clipboard + local archive (~/VoiceNotes).
